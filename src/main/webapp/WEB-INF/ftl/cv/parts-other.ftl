...
<body>
<div id="tab-other" class="parts-tab">
    <ul>
        <li>原装</li>
        <li>加减装</li>
        <li>可换装</li>
    ...
    <div id="content-other-add"></div>
    <div id="content-other-replace"></div>
</div>
<script type="text/javascript">
    var tabOtherScript = $('#tab-other').kendoTabStrip({
        animation: {
            close: {
                duration: 100,
                effects: "fadeOut"
    ...
    tabOtherScript.select(0);

    var otherDataSource = new grid.dataSource({
        transport: {
            create: {
                url: "/parts/create",
                dataType: "json"
    ...
    var otherAddDataSource = new grid.dataSource({
        transport: {
            create: {
    ...
    var otherReplaceDataSource = new grid.dataSource({
        transport: {
            create: {
    ...
    var otherAddArgs = {
        ...
        dataSource:otherAddDataSource,
        dataId: 'addId'
    };

    var otherReplaceArgs = {
        toolBar:true,
        editable:true,
        columns:[
            {
        ...
        dataSource:otherReplaceDataSource,
        dataId: 'replaceId'
    };

    $('#content-other').dataGrid(otherArgs); //调用jQuery对象方法
    $('#content-other-add').dataGrid(otherAddArgs);
    $('#content-other-replace').dataGrid(otherReplaceArgs);
