...
<body>
<div id="tab-gearbox" class="parts-tab">
    <ul>
        <li>原装</li>
        <li>加减装</li>
        <li>可换装</li>
    </ul>
    <div id="content-gearbox"></div>
    <div id="content-gearbox-add"></div>
    <div id="content-gearbox-replace"></div>
</div>
<script type="text/javascript">
    var tabGearboxScript = $('#tab-gearbox').kendoTabStrip({
        animation: {
            close: {
                duration: 100,
                effects: "fadeOut"
    ...
    tabGearboxScript.select(0);

    var gearboxDataSource = new grid.dataSource({
        transport: {
            create: {
                url: "/parts/create",
                dataType: "json"
    ...
    var gearboxAddDataSource = new grid.dataSource({
        transport: {
            create: {
    ...
    var gearboxReplaceDataSource = new grid.dataSource({
        transport: {
            create: {
    ...
    var gearboxAddArgs = {
        ...
        dataSource:gearboxAddDataSource,
        dataId: 'addId'
    };

    var gearboxReplaceArgs = {
        toolBar:true,
        editable:true,
        columns:[
            {
        ...
        dataSource:gearboxReplaceDataSource,
        dataId: 'replaceId'
    };

    $('#content-gearbox').dataGrid(gearboxArgs); //调用jQuery对象方法
    $('#content-gearbox-add').dataGrid(gearboxAddArgs);
    $('#content-gearbox-replace').dataGrid(gearboxReplaceArgs);
